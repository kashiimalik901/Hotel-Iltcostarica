  ...
  <div class="card-header">
    <div class="row flex-between-end">
      <div class="col-auto align-self-center">
        <h5 class="mb-0 text-nowrap py-2 py-xl-0">Create New Hotel</h5>
      </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select class="form-select @error('setting_type') is-invalid @enderror" id="setting_type" name="setting_type">
                ...
                <option value="Beachfront" {{ old('setting_type') == 'Beachfront' ? 'selected' : '' }}>Beachfront</option>
                <option value="Mountain" {{ old('setting_type') == 'Mountain' ? 'selected' : '' }}>Mountain</option>
                <option value="City Center" {{ old('setting_type') == 'City Center' ? 'selected' : '' }}>City Center</option>
                <option value="Rural" {{ old('setting_type') == 'Rural' ? 'selected' : '' }}>Rural</option>
                <option value="Airport" {{ old('setting_type') == 'Airport' ? 'selected' : '' }}>Airport</option>
              </select>
              @error('setting_type')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6">
              ...
              <select class="form-select @error('style') is-invalid @enderror" id="style" name="style">
                ...
                <option value="Luxury" {{ old('style') == 'Luxury' ? 'selected' : '' }}>Luxury</option>
                <option value="Boutique" {{ old('style') == 'Boutique' ? 'selected' : '' }}>Boutique</option>
                <option value="Resort" {{ old('style') == 'Resort' ? 'selected' : '' }}>Resort</option>
                <option value="Eco-friendly" {{ old('style') == 'Eco-friendly' ? 'selected' : '' }}>Eco-friendly</option>
              </select>
              @error('style')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control @error('total_rooms') is-invalid @enderror" id="total_rooms" name="total_rooms" value="{{ old('total_rooms') }}" min="1">
              @error('total_rooms')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control @error('check_in_time') is-invalid @enderror" id="check_in_time" name="check_in_time" value="{{ old('check_in_time', '15:00') }}">
              @error('check_in_time')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control @error('check_out_time') is-invalid @enderror" id="check_out_time" name="check_out_time" value="{{ old('check_out_time', '11:00') }}">
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control @error('minimum_check_in_age') is-invalid @enderror" id="minimum_check_in_age" name="minimum_check_in_age" value="{{ old('minimum_check_in_age', '18') }}" min="0">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description" rows="3" placeholder="Brief description of the hotel">{{ old('short_description') }}</textarea>
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5" placeholder="Detailed description of the hotel, amenities, and features">{{ old('description') }}</textarea>
              @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('highlight_features') is-invalid @enderror" id="highlight_features" name="highlight_features" rows="3" placeholder="Key features that make this hotel special">{{ old('highlight_features') }}</textarea>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="parking_available" name="parking_available" value="1" {{ old('parking_available') ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
              ...
              <select class="form-select @error('parking_type') is-invalid @enderror" id="parking_type" name="parking_type">
                ...
                <option value="Free" {{ old('parking_type') == 'Free' ? 'selected' : '' }}>Free</option>
                <option value="Paid" {{ old('parking_type') == 'Paid' ? 'selected' : '' }}>Paid</option>
                <option value="Valet" {{ old('parking_type') == 'Valet' ? 'selected' : '' }}>Valet</option>
                <option value="Self-park" {{ old('parking_type') == 'Self-park' ? 'selected' : '' }}>Self-park</option>
              </select>
              @error('parking_type')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('parking_details') is-invalid @enderror" id="parking_details" name="parking_details" rows="3" placeholder="Additional parking information">{{ old('parking_details') }}</textarea>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="number" class="form-control @error('distance_to_airport') is-invalid @enderror" id="distance_to_airport" name="distance_to_airport" value="{{ old('distance_to_airport') }}" min="0" step="0.1">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('nearby_attractions') is-invalid @enderror" id="nearby_attractions" name="nearby_attractions" rows="3" placeholder="Popular attractions near the hotel">{{ old('nearby_attractions') }}</textarea>
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('awards') is-invalid @enderror" id="awards" name="awards" rows="3" placeholder="Awards, certifications, or recognition received">{{ old('awards') }}</textarea>
              @error('awards')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('sustainability_features') is-invalid @enderror" id="sustainability_features" name="sustainability_features" rows="3" placeholder="Eco-friendly and sustainability initiatives">{{ old('sustainability_features') }}</textarea>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select class="form-select @error('pet_policy') is-invalid @enderror" id="pet_policy" name="pet_policy">
                ...
                <option value="Pets Allowed" {{ old('pet_policy') == 'Pets Allowed' ? 'selected' : '' }}>Pets Allowed</option>
                <option value="Pets Not Allowed" {{ old('pet_policy') == 'Pets Not Allowed' ? 'selected' : '' }}>Pets Not Allowed</option>
                <option value="Service Animals Only" {{ old('pet_policy') == 'Service Animals Only' ? 'selected' : '' }}>Service Animals Only</option>
                <option value="Restricted" {{ old('pet_policy') == 'Restricted' ? 'selected' : '' }}>Restricted</option>
              </select>
              @error('pet_policy')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('cancellation_policy') is-invalid @enderror" id="cancellation_policy" name="cancellation_policy" rows="3" placeholder="Hotel's cancellation policy">{{ old('cancellation_policy') }}</textarea>
